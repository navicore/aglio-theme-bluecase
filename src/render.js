...
exports.render = function (input, options, done) {
  ...
  const result = [
    ...
    `   with command:\n`,
    `       aglio -i ${options.input} -t ${options.theme} -o ${options.output} --theme-super-class ${options.themeSuperClass} --theme-collection-type ${options.themeCollectionType} --theme-doubles ${options.themeDoubles} --theme-spray-json ${options.themeSprayJson}\n`,
